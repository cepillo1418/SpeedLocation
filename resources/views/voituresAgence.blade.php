...
@section('content')
    <div class="container-fluid py-4">
        <a href="/chef-agence" class="btn btn-outline-primary shadow-block ">Retour</a>
        <div class="col-9 d-flex flex-wrap pt-5 justify-content-center mx-auto containerVoiture">
            @foreach($voitures as $data)
                <div class="col-12 col-lg-3 col-xxl-3 d-flex flex-column  p-2 rounded m-2 blockVoiture bg-s">
                    ...
                    <a  class="btn btn-outline-primary text-white w-75 align-self-center mt-3 btn-info-car" href="{{route('statutVoiture', $data->id) }}">
                       Modifier statut
                    </a>
                </div>
            @endforeach
