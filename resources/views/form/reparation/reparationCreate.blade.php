                ...
                <div class="card bg-p shadow-block">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('createReparation') }}">
                            @csrf
                            <div class="row mb-3">
                                <label for="type" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Type d\'reparation :') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="date" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Date de l\'reparation :') }}</label>
                                <div class="col-md-6">
