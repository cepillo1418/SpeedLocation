                ...
                <div class="card bg-p shadow-block">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('createAssurance') }}">
                            ...
                            <div class="row mb-3">
                                <label for="DateDebut" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Date de debut :') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="DateFin" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Date de fin :') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="voitureId" class="form-select @error('id_voiture') is-invalid @enderror" aria-label="Default select example" name="id_voiture">
                                        <option class="option-voiture" value="null">Aucune voiture</option>
