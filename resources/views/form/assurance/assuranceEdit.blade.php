                ...
                <div class="card bg-p shadow-block">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('updateAssurance', ['id' => $assurance->id]) }}">
                            ...
                            <div class="row mb-3">
                                <label for="nom" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Nom de l\'assurance :') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="DateDebut" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Date de debut : ').'( '.date('d/m/Y', strtotime($assurance->DateDebut)).' )' }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="DateFin" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Date de fin : ').'( '.date('d/m/Y', strtotime($assurance->DateFin)).' )' }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="frais" class="col-md-4 col-form-label text-md-end color-text-gen">{{ __('Frais total :') }}</label>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select id="voitureId" class="form-select @error('id_voiture') is-invalid @enderror" aria-label="Default select example" name="id_voiture">
                                        ...
                                        @foreach($voitures as $datas)
                                            @if($assurance->id_voiture === $datas->id)
